    ...
    const fileRouter = (file, variables) => {
        ...
        if (extention == 'html') {
            ...
            return routesToFile = (request, response) => {
                ...
                console.log("extention and agent", extention, agent)
                if (agent && agent.indexOf('Mac') != -1 && (extention == 'mp4' || extention == 'm4v')) {
                    ...
                    //     console.log("streaming to mac, start, end, chuckssize", start, end, chunksize)
